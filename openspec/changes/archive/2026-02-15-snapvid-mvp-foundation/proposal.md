...
SnapVid는 "상품 사진 1장 → 15~30초 숏폼 마케팅 영상 자동 생성" AI SaaS 서비스로, 현재 기획 문서(리서치/전략/PRD/아키텍처)만 존재하고 구현 코드가 없다. MVP 12개 기능(F001~F012)의 핵심 가설("60초 이내 영상 생성 → 셀러 콘텐츠 제작 빈도 3배 증가")을 검증하기 위해 프로젝트 기반부터 전체 MVP를 구축해야 한다.
