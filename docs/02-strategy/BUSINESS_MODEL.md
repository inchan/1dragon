...
| **해상도** | 1080×1920 (HD) |
| **영상 길이** | 최대 15초 |
| **워터마크** | "Made with 1Dragon" 포함 (제거 불가) |
| **스타일/템플릿** | 기본 5개 |
| **출력 포맷** | 9:16 단일 |
| **BGM** | 기본 라이브러리(20곡) |
...
|--------|:----:|:------------:|:------------:|:----------:|----------|
| **1Dragon** | 월 3건 | **₩9,900/월** (30건) | **₩49,000/월** (150건) | **₩990,000~/월** | 이커머스 특화, 한국 플랫폼 연동 |
...
**고객이 절약하는 비용 대비 1Dragon 가격**:

| 비교 대상 | 현재 비용 | 1Dragon 비용 | 절감율 | 추가 가치 |
|----------|----------|-------------|:------:|----------|
...
- 1Dragon Pro: ₩49,000/월로 주 8~10개 영상, 생성 시간 주 1시간 이내
- **시간 절약**: 주 8시간 = 월 32시간 × ₩25,000/시간 = **₩800,000/월 시간 가치**
- **외주 절감**: **₩500,000~800,000/월**
- **총 절감**: **₩1,300,000~1,600,000/월** vs 1Dragon 비용 ₩49,000 = **ROI 2,600~3,200%**
...
graph LR
    ...
    B --> C[영상을 SNS에 게시]
    C --> D["Made with 1Dragon" 노출<br/>= 무료 마케팅]
    D --> E[새로운 사용자 유입]
    E --> A
...
```
사용자 → 영상 생성 → SNS 게시 ("Made with 1Dragon") → 시청자가 서비스 인지 → 가입
```
...
**1Dragon Year 3 ARR ₩79.8억 ($6.1M) 기준**:
